...
class App:
    ...
    def init_ats_exceptions(self):
        ats_exceptions = [
            ...
            {'key': 'NSAllowsArbitraryLoadsInWebContent', 'state': 3, 'score': -10, 'parent': None, 'description': 'App Transport Security restrictions are disabled for requests made from WebViews without affecting URLSession connections. This setting is not applicable to domains listed in NSExceptionDomains.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity/nsallowsarbitraryloadsinwebcontent/'},
            {'key': 'NSAllowsArbitraryLoadsForMedia', 'state': 3, 'score': -10, 'parent': None, 'description': 'App Transport Security restrictions are disabled for media loaded using the AVFoundation framework, without affecting URLSession connections.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity/NSAllowsArbitraryLoadsForMedia/'},
            {'key': 'NSAllowsLocalNetworking', 'state': 1, 'score': 0, 'parent': None, 'description': 'ATS restrictions are disabled for requests made from local networking without affecting your URLSession connections. This setting is not applicable to domains listed in NSExceptionDomains.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity/nsallowslocalnetworking/'},
            {'key': 'NSExceptionAllowsInsecureHTTPLoads', 'state': 3, 'score': -50, 'parent': 'NSExceptionDomains', 'description': 'Insecure communication to the specified domain is allowed.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsexceptionallowsinsecurehttploads'},
            {'key': 'NSIncludesSubdomains', 'state': 3, 'score': -10, 'parent': 'NSExceptionDomains', 'description': 'NSIncludesSubdomains applies the ATS exceptions for the given domain to all subdomains as well.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsincludessubdomains/'},
            {'key': 'NSExceptionMinimumTLSVersion-TLSv1.0', 'state': 3, 'score': -40, 'parent': 'NSExceptionDomains', 'description': 'The minimum TLS version is set to 1.0. This version is vulnerable to attacks such as POODLE, FREAK or CurveSwap etc. As of right now (December 2021) this is the default.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsexceptionminimumtlsversion/'},
            {'key': 'NSExceptionMinimumTLSVersion-TLSv1.1', 'state': 3, 'score': -30, 'parent': 'NSExceptionDomains', 'description': 'The minimum TLS version is set to 1.1. This version is vulnerable to multiple attacks and considered insecure.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsexceptionminimumtlsversion/'},
            {'key': 'NSExceptionRequiresForwardSecrecy', 'state': 3, 'score': -20, 'parent': 'NSExceptionDomains', 'description': 'The requirement of Perfect Forward Secrecy (PFS) is set to NO. By default (if the key is missing or the value is set to YES) the accepted ciphers are limits to those that support perfect forward secrecy (PFS) through the Elliptic Curve Diffie-Hellman Ephemeral (ECDHE) key exchange.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsexceptionrequiresforwardsecrecy/'},
        ]
