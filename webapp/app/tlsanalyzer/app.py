...
class App:
    ...
    def init_ats_exceptions(self):
        ats_exceptions = [
            {'key': 'NSExceptionDomains', 'state': 1, 'parent': None, 'description': 'Custom App Transport Security configurations for named domains.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity/nsexceptiondomains/'},
            {'key': 'NSPinnedDomains', 'state': 0, 'parent': None, 'description': 'A collection of certificates that App Transport Security enforces when connecting to named domains.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsapptransportsecurity/nspinneddomains/'},
            {'key': 'NSExceptionMinimumTLSVersion-TLSv1.3', 'state': 0, 'parent': 'NSExceptionDomains', 'description': 'The minimum TLS version is set to 1.3. This is considered secure since enforcing TLS 1.3 is more strict than the default (1.2).', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsexceptionminimumtlsversion/'},
        ...
        for ats_exception in ats_exceptions:
            ...
            if model is None:
                model = AtsException(key, ats_exception['state'], ats_exception['description'],
                                     ats_exception['documentation_url'])
