...
class App:
    ...
    def init_ats_exceptions(self):
        ats_exceptions = [
            ...
            {'key': 'NSExceptionAllowsInsecureHTTPLoads', 'state': 3, 'score': 150, 'parent': 'NSExceptionDomains', 'description': 'Insecure communication the specified domain is allowed.', 'documentation_url': 'https://developer.apple.com/documentation/bundleresources/information_property_list/nsexceptionallowsinsecurehttploads'},
